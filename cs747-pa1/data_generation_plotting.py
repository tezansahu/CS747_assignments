from submission.bandit import Bandit, Experiment, EpsilonGreedy, UCB, KL_UCB, ThompsonSampling
...
def task1(instance, seed_start, seed_end):
    ...
    plt.ylabel("Regret")
    plt.xlabel("Horizon")
    plt.title("Bandit Instance {}: Regret vs Horizon".format(instance))
    ...
    plt.savefig("outputs/i-{}.png".format(instance))
...
def task3(task_1 = True, task_2 = True):
    ...
    if task_1:
        ...
        for i in range(1, 4):
            ...
            plt.savefig("outputs/i-{}.png".format(i))
